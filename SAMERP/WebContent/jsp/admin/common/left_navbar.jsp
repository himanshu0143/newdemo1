...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="tables.html"><i class="icon icon-th"></i> <span>Purchase</span></a></li>
    <li><a href="/SAMERP/jsp/admin/settings/expenses.jsp"><i class="icon icon-money"></i> <span>Expenses</span></a> </li>
    <li><a href="grid.html"><i class="icon icon-fullscreen"></i> <span>Work Details</span></a></li>
    <li><a href="interface.html"><i class="icon icon-pencil"></i> <span>Report</span></a></li>
  </ul>
</div>
<!--sidebar-menu-->
